...
async function analyzeStatically(targetImage, dockerfileAnalysis, imageType, imagePath, excludeBaseImageVulns, globsToFind, appScan) {
    ...
    const depGraph = await dep_graph_1.legacy.depTreeToGraph(dependenciesTree, parsedAnalysisResult.type);
    const analysis = Object.assign(Object.assign({}, staticAnalysis), { depGraph, depTree: dependenciesTree, imageId: parsedAnalysisResult.imageId, imageLayers: parsedAnalysisResult.imageLayers });
